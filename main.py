...
def get_birthdays_per_week(users):
    ...
    start_of_week = today + datetime.timedelta(days=(7 - current_weekday))
    ...
    for user in users:
        ...
        if start_of_week <= birthday <= end_of_week:
            ...
            birthdays_by_day[birthday_weekday].append(user['name'])
...
users = [
    ...
    {'name': 'Kim', 'birthday': datetime.date(2002, 9, 8)},
    {'name': 'Jan', 'birthday': datetime.date(2003, 9, 8)},
]
